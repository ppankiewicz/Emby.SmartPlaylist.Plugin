...
namespace SmartPlaylist.Domain
{
    ...
    public class RandomLimitOrder : LimitOrder
    {
        ...
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.Random, SortOrder.Ascending) };
    }

    public class AlbumLimitOrder : LimitOrder
    {
        public override string Name => "Album";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[]{(ItemSortBy.Album, SortOrder.Ascending)};
    }
    ...
    public class ArtistLimitOrder : LimitOrder
    {
        ...
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.Artist, SortOrder.Ascending) };
    }

    public class AlbumArtistLimitOrder : LimitOrder
    {
        public override string Name => "Album artist";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.AlbumArtist, SortOrder.Ascending) };
    }

    public class MostFavoriteLimitOrder : LimitOrder
    {
        public override string Name => "Most favorite";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.IsFavorite, SortOrder.Descending) };
    }

    public class LessFavoriteLimitOrder : LimitOrder
    {
        public override string Name => "Less favorite";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.IsFavorite, SortOrder.Ascending) };
    }
    ...
    public class AddedDateDescLimitOrder : LimitOrder
    {
        ...
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.DateCreated, SortOrder.Descending) };
    }

    public class AddedDateAscLimitOrder : LimitOrder
    {
        public override string Name => "Added date asc";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.DateCreated, SortOrder.Ascending) };
    }

    public class MostPlayedLimitOrder : LimitOrder
    {
        public override string Name => "Most played";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.PlayCount, SortOrder.Descending) };
    }

    public class LeastPlayedLimitOrder : LimitOrder
    {
        public override string Name => "Least played";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.PlayCount, SortOrder.Ascending) };
    }

    public class PlayedDateDescLimitOrder : LimitOrder
    {
        public override string Name => "Played date desc";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.DatePlayed, SortOrder.Descending) };
    }

    public class PlayedDateAscLimitOrder : LimitOrder
    {
        public override string Name => "Played date asc";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.DatePlayed, SortOrder.Ascending) };
    }

    public class NameLimitOrder : LimitOrder
    {
        public override string Name => "Name";
        public override (string, SortOrder)[] OrderBy => new (string, SortOrder)[] { (ItemSortBy.Name, SortOrder.Ascending) };
    }
